...
exports.getDefaultSetting = function(serverPath) {
  ...
  var setting = {
    // web app
    app_name: process.env.LEAPEASE_APP_NAME || 'leapease',
    website: process.env.LEAPEASE_WEBSITE || 'http://localhost',
    ...
    http_port: process.env.LEAPEASE_HTTP_PORT || 8080,
    ...
    database: {
      ...
      name: process.env.LEAPEASE_DATABASE_NAME || 'leapease'
    },
    // socketio
